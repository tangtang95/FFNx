...
void ff7_find_externals(struct ff7_game_obj* game_object)
{
	...
	ff7_externals.ifrit_wave_effect_pointer = (int*)get_absolute_value(ff7_externals.ifrit_sub_595A05, 0x29);
	ff7_externals.battle_viewport_y = (int*)get_absolute_value(battle_main_loop, 0x15E);
